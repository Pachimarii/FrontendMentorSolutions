    ...
    return (
        <main className="home-main-content">
            <div className="app-attribute">
                <div className="app-attribute-text">
                    <h2 className="app-attribute-text-header">Easy to implement</h2>
                    <p className="app-attribute-text-content">
                ...
                <div className="app-attribute-img-container">
                    <img  className="attr-img-1" src={image.easy} alt="Terminal showing simple lines of code" />
                </div>
            </div>
            <div className="app-attribute">
                <div className="app-attribute-text">
                    <h2 className="app-attribute-text-header">Simple UI & UX</h2>
                    <p className="app-attribute-text-content">
                        Our pre-built form is easy to integrate in your app or website’s checkout flow and designed to optimize conversion.
                    </p>
                </div>
                <div className="app-attribute-img-container">
                    <img className="attr-img-2" src={image.simple} alt="iPhones showing simple UI of PayAPI mobile app" />
                </div>
            </div>
            <div className="app-attribute-grid">
