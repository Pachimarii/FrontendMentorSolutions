...
const Form = () => {
    ...
    function isEmpty() {
        ...
        inputElements.forEach(input => {
            if (input.children[0].value === undefined) {
                input.children[1].innerText = `This field can't be empty`
            } else if (input.children[0].value.trim() === '') {
    ...
    return (
        <form className="contact-form" ref={formElement} onSubmit={handleFormSubmit}>
            ...
            <div className="contact-form-control">
                ...
                <small className={`email-list ${emailList ? 'checked' : ''}`} onClick={() => {setEmailList(!emailList)}}>
